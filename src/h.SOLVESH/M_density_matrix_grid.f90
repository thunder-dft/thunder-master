...
! Allocate Arrays
! ===========================================================================
        allocate (s%denmat_old (s%natoms))
...
! Read from input file - gives dos options
          ...
          do iatom = 1, s%natoms
            ...
            do ineigh = 1, num_neigh  ! <==== loop over i's neighbors
              ...
              read (inpfile) s%denmat_old(iatom)%neighbors(ineigh)%block
...
! ===========================================================================
        do iatom = 1, s%natoms
          do ineigh = 1, s%neighbors(iatom)%neighn
            ...
            deallocate (s%denmat_old(iatom)%neighbors(ineigh)%block)
          end do
          deallocate (s%denmat(iatom)%neighbors)
          deallocate (s%denmat_old(iatom)%neighbors)
        end do
        deallocate (s%denmat)
        deallocate (s%denmat_old)
