...
! ===========================================================================
        ...
        ! absolutes of density gradients
        real agrup, agrdn, agrad
        real delgrup, delgrdn, delgrad

        ! Laplacians
        real uplap, dnlap

        ! output of easypbe
        real exlsd, vxuplsd, vxdnlsd, eclsd, vcuplsd, vcdnlsd
        real expw91, vxuppw91, vxdnpw91, ecpw91, vcuppw91, vcdnpw91
...
! absolute value of densities and gradients
          agrup = abs(dp(1))
          agrdn = abs(dp(2))
          agrad = abs(rhop)
...
! Laplacians
          ...
          call easypbe (d(1), agrup, delgrup, uplap, d(2), agrdn, delgrdn,   &
     &                  dnlap, agrad, delgrad, 1, 1,                         &
     &                  exlsd, vxuplsd, vxdnlsd, eclsd, vcuplsd, vcdnlsd,    &
     &                  expw91, vxuppw91, vxdnpw91, ecpw91, vcuppw91,        &
     &                  vcdnpw91, expbe, vxuppbe, vxdnpbe, ecpbe, vcuppbe,   &
     &                  vcdnpbe)
